package com.degan.uefaleague.database
...
class Database {
    companion object {
        ...
        fun getUefaGames() : List<Game> = listOf(
                    Game(
        ...
        fun getLibertadoresGames() : List<Game> = listOf(
                Game(
                ...
                Game(
                        Team("Emelec", R.drawable.es_emelec, R.drawable.ic_equador, 0),
                        Team("The Strongrest", R.drawable.es_the_strongest, R.drawable.ic_bolivia, 0),
                        "Hernando Siles",
                        "10/07/2017",
                        "21:45"
                ))

        fun getAFCGames() : List<Game> = listOf(
                Game(
                ...
                Game(
                        Team("Kawasaki", R.drawable.es_kawasaki, R.drawable.ic_japao, 0),
                        Team("Urawa Reds", R.drawable.es_al_duhail, R.drawable.ic_arabia_saudita, 0),
                        "Jeju World Cup Stadium",
                        "29/05/2017",
                        "20:15"
                )
